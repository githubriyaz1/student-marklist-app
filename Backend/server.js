...
// 1. Replace the entire string with the one you copied from Atlas.
// 2. IMPORTANT: Replace `<password>` with your actual database password.
// 3. Replace `myFirstDatabase` with your desired database name (e.g., `studentDB`).
const dbURI = 'mongodb+srv://students:23ITR061@cluster0.elnq9xz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
...
.then(() => console.log('Successfully connected to MongoDB Atlas!')) // Updated log message
